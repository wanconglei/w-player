class MediaFile
  ...
  class << self
    def file_paths
      ...
      raise MusicError::InvalidFilePath, I18n.t('error.media_path_blank') unless File.exist?(media_path)
      raise MusicError::InvalidFilePath, I18n.t('error.media_path_unreadable') unless File.readable?(media_path)
